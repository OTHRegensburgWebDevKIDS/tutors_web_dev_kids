...
Erklären Sie Ihrem Nachbarn, oder sich selbst, fall kein Nachbar verfügbar, (als wäre er oder sie eine Quietscheente) den Code Zeile für Zeile, wenn die folgenden Seiten im Browser aufgerufen werden (die URL müssen Sie auf Ihren eigenen *Codespace* anpassen):

- `https://crispy-capybara-.../about`
- `https://crispy-capybara-.../`
