...
Modifizieren Sie nun die Startseite (`index.hbs`), indem Sie den `card-header` - `Welcome to the Web App template` komplett löschen und den Text darunter ändern (siehe Screenshot).
