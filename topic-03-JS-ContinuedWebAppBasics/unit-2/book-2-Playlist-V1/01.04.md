...
In dem soeben angelegten `partial` haben wir eine Tabelle als statischen HTML-Code eingefügt. Dies soll nun durch ein dynamisches Verfahren ersetzt werden, in dem die Daten vom Controller geladen und dann an den View übergeben werden.
